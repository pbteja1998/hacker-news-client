        ...
        <div>
          ...
          <div className='mt-3 flex items-center'>
            <div>
              <div className='flex text-sm leading-5 text-gray-500'>
                <time className='bg-gray-400 w-20 h-3' />
                <span className='mx-1 bg-gray-400 w-4 h-3' />
                <p className='bg-gray-400 w-20 h-3' />
                <>
                  <span className='mx-1 bg-gray-400 w-4 h-3' />
                  <a href={'#'} className='bg-gray-400 w-20 h-3' />
                </>
              </div>
            </div>
          </div>
          <div className='flex items-center mt-1'>
            <div className='flex items-center'>
              <span className='mx-1 bg-gray-400 w-4 h-4'></span>
              <p className='bg-gray-400 w-32 h-4'></p>
            </div>
